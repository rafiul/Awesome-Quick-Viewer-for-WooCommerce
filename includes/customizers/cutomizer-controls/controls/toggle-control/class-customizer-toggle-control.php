...
class Awqv_Customizer_Toggle_Control extends \WP_Customize_Control {
	public $type = 'ios';
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-toggle-control-js', $this->awqv_controller_path() . '/toggle-control/js/customizer-toggle-control.js', array( 'jquery' ), rand(), true );
		wp_enqueue_style( 'customizer-toggle-control-css', $this->awqv_controller_path() . '/toggle-control/css/customizer-toggle-control-min.css', array(), rand() );
	...
	public function awqv_controller_path(){
