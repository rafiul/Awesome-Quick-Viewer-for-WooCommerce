...
/**
	...
	class Awqv_Slider_Custom_Control extends \WP_Customize_Control {
		/**
		...
		public function enqueue() {
			$assets_path = AWQV_PATH . '/includes/customizers/cutomizer-controls/controls/slider-range-control/assets';
